...
const HeaderComponent = () => {
   ...
   return (
        <header className="flex justify-between items-center py-10">
            <h1 className="text-primary-color text-2xl font-semibold">LumosBlog</h1>

            <button className="md:hidden xl:hidden text-primary-color" onClick={handleOpen}>
               <FaBars size={24} />
            </button>
            
            <nav className={`bg-[#090D1F] transition duration-500 md:bg-white md:static fixed left-0 right-0 top-0 bottom-0 md:translate-x-0 ${isOpen ? "translate-x-0" : "translate-x-[800px]"} flex items-center flex-col justify-center md:flex-row gap-10`}>
               <ul className="flex flex-col md:flex-row items-center gap-5">
                  ...
                  <li>
                     <Link className="text-white md:text-primary-color text-sm p-2 transition duration-500 ease-in-out hover:text-gray-900" to={"/blog"}>
                     Blog
                     </Link>
                  </li>
                  <li>
                     <Link className="text-white md:text-primary-color text-sm p-2 transition duration-500 ease-in-out hover:text-gray-900" to={"/about"}>About</Link>
                  </li>
                  <li>
                     <Link className="text-white md:text-primary-color text-sm p-2 transition duration-500 ease-in-out hover:text-gray-900" to={"/newsletter"}>Newsletter</Link>
                  </li>

                  <button><svg width="96" height="40" viewBox="0 0 96 40" fill="none" xmlns="http://www.w3.org/2000/svg">
